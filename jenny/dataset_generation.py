...
class TimeSeriesGenerator:
    ...
    def generate(self, start_ts: datetime, n: int) -> TimeSeries:
        ...
        noise_points = np.fromiter((self.noise.generate() for _ in date_points), dtype=float)
...
class TextFeatureGenerator(FeatureGenerator):
    def __init__(
        ...
        self.percentage_deviation = percentage_deviation_generator or NormalPercentageDeviation()
        self.fake = Faker()
